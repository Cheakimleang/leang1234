...
.setColor(COLOR)
.setDescription(`These are the command ${client.user.username} Bot, INVITE ME - https://discord.com/oauth2/authorize?client_id=701991865972555827&scope=bot&permissions=8`)
